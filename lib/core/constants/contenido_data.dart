...
""",
      ...
      ArticuloContenido(
        ...
        descripcion:
            "Los controles prenatales son esenciales para asegurar que tanto tú como tu bebé se encuentren en buen estado de salud.",
        bloques: [
          ContenidoBloque(
            tipo: TipoBloque.texto,
            valor: """
...
""",
      ...
      ArticuloContenido(
        ...
        imagen:
            "https://res.cloudinary.com/dqqhqnbny/image/upload/v1771559260/emociones-embarazo.png_vmsise.webp",
        descripcion:
            "El embarazo implica cambios físicos evidentes, pero también cambios emocionales importantes debido a las hormonas.",
        bloques: [
          ContenidoBloque(
            tipo: TipoBloque.texto,
            valor: """
...
""",
      ...
      ArticuloContenido(
        ...
        imagen:
            "https://res.cloudinary.com/dqqhqnbny/image/upload/v1771559495/images_12_qul8j3.jpg",
        descripcion:
            "La lactancia materna es el alimento ideal para el recién nacido durante los primeros seis meses de vida.",
        bloques: [
          ContenidoBloque(
            tipo: TipoBloque.texto,
            valor: """
...
""",
      ...
      ArticuloContenido(
        ...
        imagen:
            "https://res.cloudinary.com/dqqhqnbny/image/upload/v1771559609/WhatsApp-Image-2020-04-02-at-20.43.03-1024x1024_az38t8.jpg",
        descripcion:
            "El sueño es fundamental para el crecimiento y desarrollo cerebral del bebé.",
        bloques: [
          ContenidoBloque(
            tipo: TipoBloque.texto,
            valor: """
  ...
  TemaContenido(
    ...
    articulos: [
      ArticuloContenido(
        ...
        imagen:
            "https://res.cloudinary.com/dqqhqnbny/image/upload/v1771562066/images_13_fmrkuv.jpg",
      ...
      ArticuloContenido(
        ...
        imagen:
            "https://res.cloudinary.com/dqqhqnbny/image/upload/v1771562117/images_14_gzoeqm.jpg",
        descripcion: "Causas y soluciones",
        bloques: [],
        urlExterna:
            "https://www.natalben.com/el-embarazo-y-tus-dudas/dolor-lactancia-materna",
      ),
    ],
  ),
  ...
  TemaContenido(
    ...
    articulos: [
      ArticuloContenido(
        ...
        imagen:
            "https://res.cloudinary.com/dqqhqnbny/image/upload/v1771565131/images_15_qx0f7g.jpg",
        bloques: [
          ContenidoBloque(
            tipo: TipoBloque.texto,
          ...
          ContenidoBloque(
            ...
            valor:
                "https://res.cloudinary.com/dqqhqnbny/image/upload/v1771565292/istockphoto-1455417356-612x612_stjqpt.jpg",
          ),
          ContenidoBloque(
            tipo: TipoBloque.texto,
