...
import 'package:lactaamor/features/contenidos/view/widgets/detalle_especialista_screen.dart';
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                final especialistas = docs
                    .map(
                      (doc) => Especialista.fromFirestore(
                        doc.id,
                        doc.data() as Map<String, dynamic>,
                      ),
                    )
                    .where(
                      (esp) => esp.especializacion.toLowerCase().contains(
                        searchText,
                      ),
                    )
                    .toList();
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      leading: CircleAvatar(
                        backgroundImage: NetworkImage(esp.foto),
                      ),
                      ...
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                DetalleEspecialistaScreen(especialista: esp),
                          ),
                        );
                      },
                    );
